...
Follow.prototype.validate = async function (action) {
  ...
  if (followedAccount) {
    ...
    this.errors.push("User does not exist, so cannot follow");
  }

  let doesFollowedAlreadyExist = await followsCollection.findOne({
  ...
  if (action == "delete") {
    if (!doesFollowedAlreadyExist) {
      this.errors.push("You do not follow the user");
    }
  }
